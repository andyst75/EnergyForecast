...
- МАЕ, поскольку показывает прогнозную ошибку в абсолютных значениях (МВт/час), что позволяет оценить фактическую ошибку. 
...
-  Простая линейная модель хорошо улучшает прогноз наивной модели, например при прогнозе на три дня значение метрики MAPE уменьшилось с 2,88 до 2,16
